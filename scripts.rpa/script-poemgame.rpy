...
label poem(transition=True):
    ...
    if persistent.playthrough == 0 and chapter == 0:
        call screen dialog("Şiir yazma vakti!\n\nFavorin olan kulüp üyesinin seveceğini\ndüşündüğün kelimeleri seç. Şiirini en\nçok seven kişiyle güzel şeyler yaşayabilirsin!", ok_action=Return())
    python:
